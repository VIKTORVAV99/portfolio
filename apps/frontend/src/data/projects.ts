...
import electricityMapsImage from "$lib/images/projects/Electricity_Maps.png?enhanced";
...
const projects: Array<ProjectConfig> = [
  {
    ...
    keywords: ["SPA", "React", "Python", "Electricity", "CO2", "Emissions", "Tailwind CSS"],
    technologies: [
      {
        name: "React",
        description: "Underlying framework and the core of the project.",
        url: "https://reactjs.org/",
        preview: true,
      },
      {
        name: "Tailwind CSS",
        description: "Utility-first CSS framework used to style the project.",
      ...
      {
        name: "Python",
        description: "Used to build the data gathering parts of the open source project.",
    ...
    preview: {
      description:
        "Electricity Maps provides actionable electricity data for more than 160 regions around the globe. The company mission is to help businesses and organizations more effectively reduce their carbon emissions, and enable products and services that empower end-users to be more carbon conscious.",
      image: {
        src: electricityMapsImage,
        alt: "Electricity Maps Hero Image",
        aspectRatio: "716/454",
      },
    },
    details: {
      tagline: "The leading resource for 24/7 electricity CO₂ data",
      description:
  ...
  },
  {
    ...
    links: [
      {
        title: "GitHub Repository",
        url: "https://github.com/viktorvav99/portfolio",
      },
    ],
    keywords: [
      "Portfolio",
    ...
    technologies: [
      ...
      },
      {
        ...
        description: "Meta framework for Svelte with built in static site generator and routing.",
        preview: true,
      },
      {
        name: "Tailwind CSS",
    ...
    preview: {
      description:
        "Online portfolio to showcase the projects I've worked on and the frameworks and tools I used on these projects. The portfolio is built with Svelte, SvelteKit, TailwindCSS, Skeleton and TypeScript.",
    },
    details: {
      tagline:
  ...
  },
  {
    ...
    links: [
      {
        title: "GitHub Repository",
        url: "https://github.com/VIKTORVAV99/MyWebsite-Angular",
      },
      {
        title: "Live Demo",
        url: "https://mywebsite-angular.web.app/",
      },
    ],
    keywords: [
      "SPA",
    ...
    technologies: [
      ...
      },
      {
        ...
        description: "Angular specific implementation of the Material Design Framework.",
      },
      {
        name: "Angular Fire",
        description:
    ...
    preview: {
      description:
        "A simple Angular demo project for a school project to showcase the Angular framework and the Angular CLI. ",
    },
    details: {
      tagline:
  ...
  },
  {
    ...
    preview: {
      description:
        "A Discord bot that helps players of the game Upland to find the shortest path between two properties.",
    },
    details: {
      tagline:
